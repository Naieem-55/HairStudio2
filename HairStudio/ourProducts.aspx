<%@ Page Title="Hair Studio - Our Products" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ourProducts.aspx.cs" Inherits="HairStudio.ourProducts" %>
    ...
    <section class="section-warm">
        <div class="row">
            <div class="col-md-6 mx-auto">
                ...
                <p class="section-title">Our Quality Products</p>
            </div>
        </div>
    </section>
    ...
    <section class="section-light">
        <div class="container-fluid mt-20 mb-20">
            ...
            <div class="row row-cols-1 row-cols-md-2 g-3">
                ...
                <div class="col">
                    <div class="card">
                        <img src="images/product7.jpg" class="card-img-top" alt="Hair gel styling product" loading="lazy"/>
                        <div class="card-body">
                ...
                <div class="col">
                    <div class="card">
                        <img src="images/product8.jpg" class="card-img-top" alt="Hair brush for styling" loading="lazy"/>
                        <div class="card-body">
                            <h5 class="card-title">HAIR BRUSH</h5>
                            <p class="card-text">Product ID : o11</p>
                            <p class="card-text">Hair brush is essentially used to design hair in unique style with gorgeous look.</p>
                        </div>
                ...
                <div class="col">
                    <div class="card">
                        <img src="images/product9.jpg" class="card-img-top" alt="Charcoal shampoo bottle" loading="lazy"/>
                        <div class="card-body">
                        ...
                        <p class="product-price">Price : 560 BDT</p>
                        <div class="form-group">
         ...
         <div class="container-fluid mt-20 mb-20">
            ...
            <div class="row row-cols-1 row-cols-md-2 g-3">
                ...
                <div class="col">
                    <div class="card">
                        <img src="images/product10.jpg" class="card-img-top" alt="Fresh wash facial cleanser" loading="lazy"/>
                        <div class="card-body">
                            <h5 class="card-title">FRESH WASH</h5>
                            <p class="card-text">Product ID : o13</p>
                            <p class="card-text">Smooth and light fresh wash to make skin glow and healthy.</p>
                        </div>
                ...
                <div class="col">
                    <div class="card">
                        <img src="images/product5.jpg" class="card-img-top" alt="Snow hair care product" loading="lazy"/>
                        <div class="card-body">
                        ...
                        <p class="product-price">Price : 700 BDT</p>
                        <div class="form-group">
                ...
                <div class="col">
                    <div class="card">
                        <img src="images/product6.jpg" class="card-img-top" alt="Combo package with multiple products" loading="lazy"/>
                        <div class="card-body">
                            <h5 class="card-title">COMBO PACKAGE</h5>
                            <p class="card-text">Product ID : o15</p>
                            <p class="card-text">Dry shampoo, hair gel, fresh wash, cream and hair brush together.</p>
                        </div>

                        <p class="product-price">Price : 1200 BDT</p>
                        <div class="form-group">
    ...
    <section class="section-light">
        <div class="container-fluid mt-20 mb-20">
            ...
            <div class="row row-cols-1 row-cols-md-2 g-3">
                ...
                <div class="col">
                    <div class="card">
                        <img src="images/product7.jpg" class="card-img-top" alt="Beard oil for grooming" loading="lazy"/>
                        <div class="card-body">
                        ...
                        <p class="product-price">Price : 450 BDT</p>
                        <div class="form-group">
                ...
                <div class="col">
                    <div class="card">
                        <img src="images/product8.jpg" class="card-img-top" alt="Hand wash soap" loading="lazy"/>
                        <div class="card-body">
                        ...
                        <p class="product-price">Price : 220 BDT</p>
                        <div class="form-group">
                ...
                <div class="col">
                    <div class="card">
                        <img src="images/product9.jpg" class="card-img-top" alt="Hair shampoo bottle" loading="lazy"/>
                        <div class="card-body">
                        ...
                        <p class="product-price">Price : 520 BDT</p>
                        <div class="form-group">
         ...
         <div class="container-fluid mt-20 mb-20">
            ...
            <div class="row row-cols-1 row-cols-md-2 g-3">
                ...
                <div class="col">
                    <div class="card">
                        <img src="images/product10.jpg" class="card-img-top" alt="Colour gel for hair" loading="lazy"/>
                        <div class="card-body">
                ...
                <div class="col">
                    <div class="card">
                        <img src="images/product11.jpg" class="card-img-top" alt="Hair straightener tool" loading="lazy"/>
                        <div class="card-body">
                            <h5 class="card-title">HAIR STRAIGHTENER</h5>
                            <p class="card-text">Product ID : o20</p>
                            <p class="card-text">A transformative tool for sleek, smooth, and stylish locks.</p>
                        </div>

                        <p class="product-price">Price : 800 BDT</p>
                        <div class="form-group">
                ...
                <div class="col">
                    <div class="card">
                        <img src="images/product12.jpg" class="card-img-top" alt="Charcoal gel product" loading="lazy"/>
                        <div class="card-body">
                        ...
                        <p class="product-price">Price : 490 BDT</p>
                        <div class="form-group">
    ...
    <section class="section-light">
        <div class="container-fluid mt-20 mb-20">
            ...
            <div class="row row-cols-1 row-cols-md-2 g-3">
                ...
                <div class="col">
                    <div class="card">
                        <img src="images/product13.jpg" class="card-img-top" alt="Deep cleansing soap" loading="lazy"/>
                        <div class="card-body">
                        ...
                        <p class="product-price">Price : 350 BDT</p>
                        <div class="form-group">
                ...
                <div class="col">
                    <div class="card">
                        <img src="images/product14.jpg" class="card-img-top" alt="Argan gel for hair care" loading="lazy"/>
                        <div class="card-body">
                        ...
                        <p class="product-price">Price : 600 BDT</p>
                        <div class="form-group">
                ...
                <div class="col">
                    <div class="card">
                        <img src="images/product15.jpg" class="card-img-top" alt="Gel shampoo for hair" loading="lazy"/>
                        <div class="card-body">
         ...
         <div class="container-fluid mt-20 mb-20">
            ...
            <div class="row row-cols-1 row-cols-md-2 g-3">
                ...
                <div class="col">
                    <div class="card">
                        <img src="images/product16.jpg" class="card-img-top" alt="Perfume fragrance bottle" loading="lazy"/>
                        <div class="card-body">
                        ...
                        <p class="product-price">Price : 750 BDT</p>
                        <div class="form-group">
                ...
                <div class="col">
                    <div class="card">
                        <img src="images/product17.jpg" class="card-img-top" alt="Shaving cream for smooth shave" loading="lazy"/>
                        <div class="card-body">
                        ...
                        <p class="product-price">Price : 430 BDT</p>
                        <div class="form-group">
                ...
                <div class="col">
                    <div class="card">
                        <img src="images/product18.jpg" class="card-img-top" alt="Talcum powder for skin care" loading="lazy"/>
                        <div class="card-body">
                            <h5 class="card-title">TALCUM POWDER</h5>
                            <p class="card-text">Product ID : o27</p>
                            <p class="card-text">A soothing remedy for skin ailments and discomfort & makes glow.</p>
                        </div>

                        <p class="product-price">Price : 360 BDT</p>
                        <div class="form-group">
